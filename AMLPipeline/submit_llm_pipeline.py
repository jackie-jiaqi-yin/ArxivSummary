...
logic_app_name = os.getenv('LOGIC_APP_LLM_SECRET_NAME', 'llm-newsletter-logic-app-webhook-url')
blob_path_prefix = f"{os.getenv('AZURE_DATASTORE_NAME', 'workspaceblobstore')}/ArxivSummary/current"

@pipeline(
    default_compute = cpu_compute_target,
    description = 'LLM ArXiv paper summary'
)
...
# submit the pipeline
submitted_job = ml_client.jobs.create_or_update(pipeline_job, experiment_name='LLM ArXiv Summary Pipeline')
